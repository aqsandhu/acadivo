...
class PrincipalNotificationsScreen extends ConsumerStatefulWidget {
  const PrincipalNotificationsScreen({super.key});
  @override
  ConsumerState<PrincipalNotificationsScreen> createState() => _PrincipalNotificationsScreenState();
}

class _PrincipalNotificationsScreenState extends ConsumerState<PrincipalNotificationsScreen> {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: Text(
                                  n.createdAt != null ? '${n.createdAt!.day}/${n.createdAt!.month}' : '',
