...
class _StudentQaScreenState extends ConsumerState<StudentQaScreen> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {'question': 'What is the exam schedule?', 'answer': 'Mid-term exams start from April 1st.', 'date': '2024-03-15'},
    {'question': 'How to submit homework online?', 'answer': 'You can submit through the homework section.', 'date': '2024-03-10'},
  ];
